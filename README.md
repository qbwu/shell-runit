...
* 遵循[shell编程规范](http://wiki.xxxxx.com/pages/viewpage.action?pageId=70992849)

## 2 参考和帮助(hints)

* 如果仍不明白题目，请看[这个帮助视频](http://gitlab.xxxxx.com/cmc-shell/runit/raw/master/mp4/runit-help.mov)
